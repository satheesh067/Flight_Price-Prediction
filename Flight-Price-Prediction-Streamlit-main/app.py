...
model = pickle.load(open(r"C:\Users\manne\Downloads\Flight-Price-Prediction-Streamlit-main\Flight-Price-Prediction-Streamlit-main\model\flight_prediction.pkl",'rb'))
